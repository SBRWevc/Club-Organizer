...
namespace Club_Organizer.Pages.Users.Class
{
    class CL_users_new_user
    {
		...
		public static void newuser()
		{
			...
			string pass = hashPass(PG_users.pass_text);
			string name = PG_users.name_text;
			string lastname = PG_users.lastname_text;
			string secondname = PG_users.secondname_text;
			string position = PG_users.position_text;
			string gender = PG_users.gender_text;
			int root = PG_users.root_text;
